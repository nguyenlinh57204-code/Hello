...
v869:AddSlider({
	Name = 'Chọn số lượng cầu tuyết cần tạo',
	Min = 5,
...
automakesnowballtoggle = v869:AddToggle({
	Name = 'Tự động tạo và nuôi cầu tuyết khổng lồ.',
	Default = false,
...
v869:AddButton({
	Name = 'Kích hoạt làm nổ toàn bộ cầu tuyết đã tạo.',
	Callback = function()
...
firework_section:AddToggle({
	Name = 'Bật chế độ spam nổ đồ vật. ',
	Default = false,
...
firework_section:AddSlider({
	Name = 'Chỉnh số lượng bom nổ cùng lúc.',
	Min = 1,
...
firework_section:AddSlider({
	Name = 'Chỉnh độ trễ thời gian giữa các lần nổ. ',
	Min = 0,
	Max = 1,
	Default = 0,
	Color = Color3.fromRGB(255, 255, 255),
...
SilentAim_Section:AddToggle({
	Name = 'Bật ngắm bắn ẩn và chỉnh tầm hoạt động (Silent-Aim Range).',
	Default = false,
...
FurtherLineExtend_Section:AddToggle({
	Name = 'Mở rộng khoảng cách kéo dây tối đa',
	Default = false,
...
FurtherLineExtend_Section:AddSlider({
	Name = 'Chỉnh mức tăng khoảng cách',
	Min = MinExtendLine,
	Max = MaxExtendLine,
	Default = 3,
	Color = Color3.fromRGB(255, 255, 255),
...
kickauratoggle = v913:AddToggle({
	Name = 'Tự động đá văng người chơi ở gần',
	Default = false,
...
v1138:AddToggle({
	Name = 'Kéo vật thể kết hợp với góc nhìn camera.',
	Default = false,
...
v1138:AddSlider({
	Name = 'Thanh trượt chỉnh tốc độ di chuyển góc nhìn',
	Min = 50,
	Max = 150,
	Default = 50,
	Color = Color3.fromRGB(255, 255, 255),
...
v1203:AddToggle({
	Name = 'Tự động phản đòn khi có người tác động bạn.',
	Default = false,
...
PlayerToTeleport = PlayerTeleport_Section:AddDropdown({
	Name = 'Danh sách chọn người chơi mục tiêu.',
	Default = '',
	Options = {
		'',
	},
...
v1295:AddToggle({
	Name = 'Tạo hiệu ứng dây hỗn loạn gây giật nhẹ server.',
	Default = false,
...
v1295:AddToggle({
	Name = 'Làm tàng hình dây kéo của bạn. ',
	Default = false,
...
local v1322 = v654:AddSection({
	Name = 'Chọn đồ chơi cần spam và bật phím tắt TAB để triệu hồi nhanh. ',
})
local v1323 = v654:AddSection({
	Name = 'Bật phím tắt K để cố định vật thể và nút Unanchor All (Bỏ cố định tất cả).',
})
local v1324 = v654:AddSection({
	Name = 'Tạo nhóm liên kết vật thể mới, quản lý danh sách nhóm (Groups) và xóa nhóm.',
})
local v1325 = v654:AddSection({
	Name = 'Bật phím tắt C để điều khiển nhân vật/quái vật khác.',
})
...
v1354:AddToggle({
	Name = 'Lặp liên tục tiêu diệt người chơi trong danh sách.',
	Default = false,
...
loopRagdoll = v1354:AddToggle({
	Name = 'Lặp liên tục làm ngã/bất tỉnh mục tiêu.',
	Default = false,
...
LongReachGrab_Player:AddButton({
	Name = 'Khóa người chơi vào tay Blobman',
	Callback = function()
		u1443(_G.PlayerToLongGrab, 2)
	end,
})
LongReachGrab_Player:AddButton({
	Name = 'Đem người chơi đó lại gần bạn',
	Callback = function()
		u1443(_G.PlayerToLongGrab)
	end,
})
LongReachGrab_Player:AddButton({
	Name = 'Đá văng người chơi được chọn',
	Callback = function()
